...
function withWeb() {
    return function configure(config, { options }) {
        ...
        config.output = Object.assign(Object.assign({}, config.output), { crossOriginLoading: options.subresourceIntegrity
                ? 'anonymous'
                : false });
        ...
        config.optimization = Object.assign(Object.assign({}, config.optimization), { minimizer, emitOnErrors: false, moduleIds: 'deterministic', runtimeChunk: options.runtimeChunk ? 'single' : false, splitChunks: {
