...
.awsui_input_2rhyz_einbc_97.awsui_input-readonly_2rhyz_einbc_120:not(#\9) {
  background-color: var(--color-background-input-default-u57378, #ffffff);
  border: var(--border-field-width-idlekx, 2px) solid var(--color-border-input-disabled-x2lopj, #e9ebed);
}
.awsui_input_2rhyz_einbc_97:not(#\9)::-webkit-input-placeholder {
  color: var(--color-text-input-placeholder-j53j3c, #5f6b7a);
  font-style: italic;
  -webkit-user-select: none;
          user-select: none;
}
.awsui_input_2rhyz_einbc_97:not(#\9)::-ms-input-placeholder {
  color: var(--color-text-input-placeholder-j53j3c, #5f6b7a);
  font-style: italic;
}
.awsui_input_2rhyz_einbc_97:not(#\9)::-moz-placeholder {
  color: var(--color-text-input-placeholder-j53j3c, #5f6b7a);
  font-style: italic;
  opacity: 1;
}
...
.awsui_input_2rhyz_einbc_97:not(#\9):focus {
...
.awsui_input_2rhyz_einbc_97:not(#\9):disabled {
...
.awsui_input_2rhyz_einbc_97:not(#\9):disabled::-webkit-input-placeholder {
  color: var(--color-text-input-placeholder-disabled-6928j8, #9ba7b6);
  -webkit-user-select: none;
          user-select: none;
}
.awsui_input_2rhyz_einbc_97:not(#\9):disabled::-ms-input-placeholder {
  color: var(--color-text-input-placeholder-disabled-6928j8, #9ba7b6);
}
.awsui_input_2rhyz_einbc_97:not(#\9):disabled::-moz-placeholder {
  color: var(--color-text-input-placeholder-disabled-6928j8, #9ba7b6);
  opacity: 1;
}
.awsui_input_2rhyz_einbc_97:not(#\9):disabled:-ms-input-placeholder {
...
.awsui_input_2rhyz_einbc_97:not(#\9):invalid {
  box-shadow: none;
}
.awsui_input_2rhyz_einbc_97.awsui_input-invalid_2rhyz_einbc_181:not(#\9) {
...
.awsui_input_2rhyz_einbc_97.awsui_input-invalid_2rhyz_einbc_181:not(#\9):focus {
...
.awsui_input_2rhyz_einbc_97.awsui_input-invalid_2rhyz_einbc_181.awsui_input-has-icon-left_2rhyz_einbc_192:not(#\9) {
  padding-left: calc(
        var(--space-field-icon-offset-25xih0, 36px) - (var(--border-invalid-width-5jpdqn, 8px) - var(--border-field-width-idlekx, 2px))
      );
}
.awsui_input_2rhyz_einbc_97.awsui_input-type-search_2rhyz_einbc_197:not(#\9) {
  box-sizing: border-box;
  -webkit-appearance: none; /* stylelint-disable-line plugin/no-unsupported-browser-features */
}
.awsui_input_2rhyz_einbc_97.awsui_input-type-search_2rhyz_einbc_197:not(#\9)::-ms-clear {
  display: none;
}
.awsui_input_2rhyz_einbc_97.awsui_input-type-search_2rhyz_einbc_197:not(#\9)::-webkit-search-decoration {
  -webkit-appearance: none; /* stylelint-disable-line plugin/no-unsupported-browser-features */
}
.awsui_input_2rhyz_einbc_97.awsui_input-type-search_2rhyz_einbc_197:not(#\9)::-webkit-search-cancel-button {
  display: none;
}
.awsui_input_2rhyz_einbc_97.awsui_input-has-icon-left_2rhyz_einbc_192:not(#\9) {
  padding-left: var(--space-field-icon-offset-25xih0, 36px);
}
.awsui_input_2rhyz_einbc_97.awsui_input-has-icon-right_2rhyz_einbc_213:not(#\9) {
  padding-right: var(--space-field-icon-offset-25xih0, 36px);
}
.awsui_input_2rhyz_einbc_97.awsui_input-has-no-border-radius_2rhyz_einbc_216:not(#\9) {
  border-radius: var(--border-radius-dropdown-ujknaf, 8px);
}

.awsui_input-container_2rhyz_einbc_220:not(#\9) {
  display: flex;
  position: relative;
}

.awsui_input-icon-left_2rhyz_einbc_225:not(#\9) {
  position: absolute;
  pointer-events: none;
...
.awsui_input-icon-right_2rhyz_einbc_232:not(#\9) {
  position: absolute;
  top: calc(50% - var(--font-body-m-line-height-i7xxvv, 22px) / 2);
  right: calc(var(--space-field-horizontal-89h2yr, 12px) - var(--space-xxs-ynfts5, 4px));
}

.awsui_input-button-right_2rhyz_einbc_238:not(#\9) {
  /* used in test-utils */
}